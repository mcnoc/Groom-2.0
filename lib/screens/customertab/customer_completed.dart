...
class CustomerCompleted extends StatefulWidget {
  const CustomerCompleted({super.key});

  @override
  State<CustomerCompleted> createState() => _CustomerCompletedState();
}

class _CustomerCompletedState extends State<CustomerCompleted> {
  @override
